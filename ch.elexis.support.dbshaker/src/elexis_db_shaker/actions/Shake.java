...
public class Shake implements IWorkbenchWindowActionDelegate {
	 ...
	 * @since 3.0.23 only executable by a member of admin group, see 3851
	 */
	public void run(IAction action) {
		boolean isAdmin = CoreHub.acl.userIsMemberOfAdminGroup(CoreHub.actUser);
		if (!isAdmin) {
			SWTHelper.alert("Admin Rechte benoetigt.",
					"Um diese Aktion ausfuehren zu koennen muessen Sie Mitglied der Admin Gruppe sein.");
			return;
		}
